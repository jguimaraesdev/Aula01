...
class ControleProductController {
    ...
    async create(req, res) {
        const { movimento_tipo, qtd_disponivel, preco_custo, qtd_bloqueado, productId, depositId  } = req.body;
        try {
            const result = await this.controleproductService.create(movimento_tipo, qtd_disponivel, preco_custo, qtd_bloqueado, productId, depositId );
