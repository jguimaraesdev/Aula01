...
const purchaseService = new PurchaseService(db.Purchase, db.Requisition, db.Quotation, db.Product, db.ControleProduct, db.Title, db.NotaFiscal, db.Supplier,  authenticateToken);
